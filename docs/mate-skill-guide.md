# Guide : Créer une Skill avec Symfony AI Mate pour DésirVoyage

> Documentation destinée aux développeurs travaillant sur le projet **DésirVoyage**.
> Symfony 7.4 · PHP 8.4 · Docker · MySQL/MariaDB
...
2. [Installation de Mate](#2-installation-de-mate)
3. [Structure générée par `mate init`](#3-structure-générée-par-mate-init)
4. [Concepts fondamentaux](#4-concepts-fondamentaux)
5. [Créer une Skill (Tool) personnalisée](#5-créer-une-skill-tool-personnalisée)
6. [Exemples de Skills pour DésirVoyage](#6-exemples-de-skills-pour-désirvoyage)
   - 6.1 [TravelSearchTool — Rechercher des voyages](#61-travelsearchtool--rechercher-des-voyages)
   - 6.2 [ReservationSummaryTool — Résumer une réservation](#62-reservationsummarytool--résumer-une-réservation)
   - 6.3 [TravelRecommendationTool — Recommander des voyages](#63-travelrecommendationtool--recommander-des-voyages)
7. [Enregistrement dans `mate/config.php`](#7-enregistrement-dans-mateconfigphp)
8. [Configuration MCP pour les clients IA](#8-configuration-mcp-pour-les-clients-ia)
9. [Tester et déboguer les Skills](#9-tester-et-déboguer-les-skills)
10. [Bonnes pratiques](#10-bonnes-pratiques)
11. [Commandes utiles (antisèche)](#11-commandes-utiles-antisèche)
